...
def main(args):
    ...
    if video_file.startswith('https://www.youtube.com'):
        ...
        video_file = download_youtube_clip(video_file, 'temp')
...
#    parser.add_argument('--tracker_batch_size', type=int, default=12,
    parser.add_argument('--tracker_batch_size', type=int, default=8,
                        help='batch size of object detector used for bbox tracking')

    parser.add_argument('--staf_dir', type=str, default= "STAF-staf\python\openpose",
